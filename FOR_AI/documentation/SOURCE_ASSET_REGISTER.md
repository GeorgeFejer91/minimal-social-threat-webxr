...
| Social vocal cues | Web Audio oscillator synthesis | Project-authored code | Generated at runtime; no external recording | Describe exact synthesis and caption schedule. |
| Threat roughness cue | 70 Hz amplitude modulation over project-authored carriers | Project-authored implementation informed by cited research | Generated at runtime; not a copy of the published sound | Cite Arnal et al. (2015) and Taffou et al. (2021); state adaptation and validation gap. |
...
| --- | --- | --- | --- |
| Microsoft Rocketbox | 115 rigged humans, broad animations, visemes, FACS, LODs | Not bundled | Best candidate for a later human-agent condition, but selected FBX/animations must be converted, optimized, and pilot-validated. |
