...
- **2D / 3D browser preview:** the large main viewport switches between the Canvas and Three.js renderers while preserving the same authoritative scenario state. Twelve minimalist or human-proportioned agents form six conversational dyads in a large crowd entirely in front of the observer. After a longer positive exchange, a fading shrouded shadow, visible angry agent, or articulated spider approaches continuously while individual awareness, fear, avoidance, escape distance, and motion build gradually.
